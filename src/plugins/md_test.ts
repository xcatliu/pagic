...
Deno.test('[md]', async () => {
  ...
  asserts.assertEquals(
    ReactDOMServer.renderToStaticMarkup(pagePropsREADME.content!),
    '<article><h1>Text Fixtures</h1>\n<pre class="language-autoit"><code class="language-autoit"><span class="token keyword">const</span> foo<span class="token punctuation">:</span> number <span class="token operator">=</span> <span class="token number">1</span><span class="token comment">;</span>\n</code></pre>\n<h2 id="header-2">Header 2<a class="anchor" href="#header-2">§</a></h2>\n<h3 id="header-3">Header 3<a class="anchor" href="#header-3">§</a></h3>\n<h4 id="header-4">Header 4<a class="anchor" href="#header-4">§</a></h4></article>',
  );
  asserts.assertEquals(
    ReactDOMServer.renderToStaticMarkup(pagePropsREADME.contentTitle!),
    '<h1>Text Fixtures</h1>',
  );
  asserts.assertEquals(
    ReactDOMServer.renderToStaticMarkup(pagePropsREADME.contentBody!),
    '<article><pre class="language-autoit"><code class="language-autoit"><span class="token keyword">const</span> foo<span class="token punctuation">:</span> number <span class="token operator">=</span> <span class="token number">1</span><span class="token comment">;</span>\n</code></pre>\n<h2 id="header-2">Header 2<a class="anchor" href="#header-2">§</a></h2>\n<h3 id="header-3">Header 3<a class="anchor" href="#header-3">§</a></h3>\n<h4 id="header-4">Header 4<a class="anchor" href="#header-4">§</a></h4></article>',
  );
  asserts.assertEquals(
    ReactDOMServer.renderToStaticMarkup(pagePropsREADME.toc!),
...
Deno.test('[md] no_toc', async () => {
  ...
  asserts.assertEquals(
    ReactDOMServer.renderToStaticMarkup(pageProps_no_toc.content!),
    `<article><p>foo</p></article>`,
  );
  asserts.assertEquals(pageProps_no_toc.contentTitle, undefined);
  asserts.assertEquals(
    ReactDOMServer.renderToStaticMarkup(pageProps_no_toc.contentBody!),
    `<article><p>foo</p></article>`,
  );
  ...
  asserts.assertEquals(
    ReactDOMServer.renderToStaticMarkup(pageProps_no_toc2.content!),
    `<article><h1>foo</h1></article>`,
  );
  asserts.assertEquals(
    ReactDOMServer.renderToStaticMarkup(pageProps_no_toc2.contentTitle!),
    '<h1>foo</h1>',
  );
  asserts.assertEquals(
    ReactDOMServer.renderToStaticMarkup(pageProps_no_toc2.contentBody!),
    '<article></article>',
  );
