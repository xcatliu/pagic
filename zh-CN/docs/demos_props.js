...
export default {
    ...
    'excerpt': " - TypeScript 入门教程 (GitHub) - 流浪小猫的博客 (GitHub) - Deno X ranking (GitHub) - Deno 钻研之术 (GitHub) - Deno 中文手册 (GitHub) - JavaScript 20 年 (GitHub) - ECMAScript+ 面试宝典 (GitHub) - Add my site as...",
    'cover': undefined,
    'blog': {
        "isPost": false,
        "posts": [
