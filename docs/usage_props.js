...
export default {
    ...
    'toc': React.createElement("aside", { dangerouslySetInnerHTML: {
            __html: '<nav class="toc"><ol><li><a href="#installation">Installation</a><ol><li><a href="#install-deno">Install Deno</a></li><li><a href="#install-pagic">Install Pagic</a></li><li><a href="#install-via-docker">Install via Docker</a></li></ol></li><li><a href="#initialize-the-project">Initialize the project</a></li><li><a href="#run-pagic-build">Run pagic build</a></li></ol></nav>'
        } }),
    'author': "xcatliu",
    'contributors': [
        "xcatliu"
    ...
    'updated': "2020-11-10T13:50:30.000Z",
