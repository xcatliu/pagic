...
export default {
    ...
    'toc': React.createElement("aside", { dangerouslySetInnerHTML: {
            __html: '<nav class="toc"><ol><li><a href="#installation">Installation</a><ol><li><a href="#install-deno">Install Deno</a></li><li><a href="#install-pagic">Install Pagic</a></li></ol></li><li><a href="#initialize-the-project">Initialize the project</a></li><li><a href="#run-pagic">Run pagic</a></li></ol></nav>'
        } }),
    'language': {
        "code": "en",
        "name": "English",
