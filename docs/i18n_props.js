...
export default {
    ...
    'toc': React.createElement("aside", { dangerouslySetInnerHTML: {
            __html: '<nav class="toc"><ol><li><a href="#configuration">Configuration</a><ol><li><a href="#i18nlanguage">i18n.language</a></li><li><a href="#i18noverrides">i18n.overrides</a></li><li><a href="#i18nresources">i18n.resources</a></li></ol></li><li><a href="#props">props</a><ol><li><a href="#language">language</a></li></ol></li></ol></nav>'
        } }),
    'author': "xcatliu",
    'contributors': [
        "xcatliu"
