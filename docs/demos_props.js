...
export default {
    ...
    'updated': "2020-11-15T13:50:48.000Z",
    'excerpt': " - Deno X ranking (GitHub) - TypeScript 入门教程 (GitHub) - 流浪小猫的博客 (GitHub) - Deno 钻研之术 (GitHub) - Deno 中文手册 (GitHub) - JavaScript 20 年 (GitHub) - ECMAScript+ 面试宝典 (GitHub) - Add my site as...",
    'cover': undefined,
    'blog': {
        "isPost": false,
        "posts": [
