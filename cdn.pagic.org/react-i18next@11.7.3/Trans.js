// https://github.com/i18next/react-i18next/blob/master/src/Trans.js
// https://github.com/rayd/html-parse-stringify2/blob/master/lib/parse.js
...
function HTMLParse(html, options) {
    options || (options = {});
...
function renderNodes(children, targetString, i18n, i18nOptions, combinedTOpts) {
  ...
  const ast = HTMLParse(`<0>${interpolatedString}</0>`);
...
export function Trans({
  ...
  const { i18n: i18nFromContext, defaultNS: defaultNSFromContext } = React.useContext(I18nContext) || {};
